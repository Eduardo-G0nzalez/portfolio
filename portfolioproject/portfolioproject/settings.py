...
SECRET_KEY = 'django-insecure-ss=wc1*z7wx0=$$j_1b7e0no1)lzk_ffq5ivc=0u^oj$1nem8t'
...
JAZZMIN_SETTINGS = {
    "site_title": "Eduardo González",
    "site-header": "Panel de Administrador",
    "site-brand": "Mi Marca",
    "site_logo": "img/logoportfolio.png", #CAMBIAR A RUTA DE IMAGEN LOGO
    "welcome_sign": "Bienvenido Eduardo González",
